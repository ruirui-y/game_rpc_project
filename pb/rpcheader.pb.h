...
PROTOBUF_NAMESPACE_OPEN
template<> ::rpc::core::RpcHeader* Arena::CreateMaybeMessage<::rpc::core::RpcHeader>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace rpc {
namespace core {
...
class RpcHeader final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:rpc.core.RpcHeader) */ {
 public:
...
inline const std::string& RpcHeader::service_name() const {
  // @@protoc_insertion_point(field_get:rpc.core.RpcHeader.service_name)
...
void RpcHeader::set_service_name(ArgT0&& arg0, ArgT... args) {
 ...
 service_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:rpc.core.RpcHeader.service_name)
}
inline std::string* RpcHeader::mutable_service_name() {
  std::string* _s = _internal_mutable_service_name();
  // @@protoc_insertion_point(field_mutable:rpc.core.RpcHeader.service_name)
  return _s;
}
...
inline std::string* RpcHeader::release_service_name() {
  // @@protoc_insertion_point(field_release:rpc.core.RpcHeader.service_name)
...
inline void RpcHeader::set_allocated_service_name(std::string* service_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:rpc.core.RpcHeader.service_name)
}
...
inline const std::string& RpcHeader::method_name() const {
  // @@protoc_insertion_point(field_get:rpc.core.RpcHeader.method_name)
...
void RpcHeader::set_method_name(ArgT0&& arg0, ArgT... args) {
 ...
 method_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:rpc.core.RpcHeader.method_name)
}
inline std::string* RpcHeader::mutable_method_name() {
  std::string* _s = _internal_mutable_method_name();
  // @@protoc_insertion_point(field_mutable:rpc.core.RpcHeader.method_name)
  return _s;
}
...
inline std::string* RpcHeader::release_method_name() {
  // @@protoc_insertion_point(field_release:rpc.core.RpcHeader.method_name)
...
inline uint32_t RpcHeader::args_size() const {
  // @@protoc_insertion_point(field_get:rpc.core.RpcHeader.args_size)
